...
export const messages = {
  de: {
    ...
    import: "Import",
    workoutsImport: "Workouts importieren",
    ...
    aiImport: "KI-Import",
    aiGenerate: "Mit KI umwandeln",
    aiImportPlaceholder: "Füge hier den Trainingsplan ein (Text aus PDF/Notizen)",
    aiImportReady: "KI-Import bereit",
  ...
  en: {
    ...
    import: "Import",
    workoutsImport: "Import workouts",
    settings: "Settings",
    language: "Language",
    unit: "Unit",
    ...
    versionLabel: "Version",
    reset: "Reset",
    restTimerDuration: "Timer duration",
    ...
    aiImport: "AI import",
    aiGenerate: "Convert with AI",
    aiImportPlaceholder: "Paste your workout plan text here (from PDF or notes)",
    aiImportReady: "AI import ready",
