...
export const messages = {
  de: {
    ...
    lockerNoteToggleHint: "Blendet das Schranknummer-Feld oben rechts ein",
    ...
    workoutIconNone: "Kein Icon",
    workoutScheduleDays: "Planung",
    workoutScheduleDaysHelp: "Planung erklären",
    workoutScheduleDaysHelpDescription:
      "An den ausgewählten Tagen wird das Workout hervorgehoben",
    ...
    completeSession: "Session speichern",
    ...
    language: "Sprache",
    unit: "Einheit",
    weekStartsOn: "Wochenstart",
    weekStartsOnMonday: "Mo",
    weekStartsOnSunday: "So",
    ...
    afterward: "Danach",
    rest: "Pause",
    restTimer: "Satzpausen-Timer",
    workoutComplete: "Workout komplett",
    finished: "Fertig",
    ...
    completeWithTemplate: "Speichern und Vorlage anpassen",
    ...
    expandSession: "Session ausklappen",
    collapseSession: "Session einklappen",
    ...
    expandAllExercises: "Alle ausklappen",
    collapseAllExercises: "Alle einklappen",
    reorderMode: "Umsortieren",
    reorderModeStart: "Sortiermodus starten",
    reorderModeDone: "Sortieren beenden",
    reorderModeDescription: "Übungen werden eingeklappt. Ziehe dann mit dem Griff die Reihenfolge in der aktiven Session um.",
    reorderModeHint: "Ziehe die Übungen am Griff in die gewünschte Reihenfolge",
    reorderExercise: "Übung umsortieren",
    reverseSessionExerciseOrder: "Übungsreihenfolge umkehren",
    reverseShort: "Umkehren",
    reverseSessionExerciseOrderConfirm: "Soll die Reihenfolge der noch nicht gestarteten Übungen umgedreht werden?",
    saveSorting: "Sortierung anwenden",
    ...
    exerciseToggleHelp: "2× und −kg erklären",
    exerciseHelp: "Übungshilfe öffnen",
    exerciseInfo: "Übungsinfos",
    exerciseInfoGenerate: "Übungsinfos erstellen",
    exerciseInfoGenerating: "Übungsinfos werden erstellt ...",
    exerciseInfoGenerateSectionTitle: "Übungsinfos automatisch erstellen",
    exerciseInfoGenerateSectionDescription:
      "Ordnet benannte Übungen einer lokalen Übungsdatenbank zu und erstellt daraus Muskelbeteiligung und Ausführungstipps",
    ...
    exerciseInfoReloadConfirmTitle: "Übungsinfos neu erstellen?",
    exerciseInfoReloadConfirmDescription:
      "Alle Übungen in diesem Workout haben bereits Infos. Möchtest du die vorhandenen Übungsinfos entfernen und neu erstellen?",
    exerciseInfoReloadConfirmAction: "Entfernen und neu erstellen",
    exerciseInfoGenerateFailed: "Übungsinfos konnten nicht erstellt werden",
    exerciseInfoProviderNotConfigured: "Übungsdatenbank ist nicht verfügbar",
    ...
    matchedExerciseNameLabel: "Infos für",
    ...
    aiImport: "KI-Import",
    aiGenerate: "Workouts mit KI erstellen",
    ...
    yearlyData: "Jahresdaten",
    monthlyCalendar: "Monatskalender",
    monthlyCalendarSingleSession: "1 Session",
    ...
    bodyWeightHint:
      "Wird für die Berechnung des Gewichts bei assistierten Übungen mit negativen Werten und für die Kalorien-Schätzung in den Statistiken verwendet",
    ...
    muscleMetricsCalculationHint: "Gewichtet nach Übungs-Muskelanteil pro abgeschlossenem Satz (bei Gewicht: Volumen = Gewicht × Reps)",
    noMuscleDataThisWeek: "Noch keine Muskelgruppen-Daten",
    noMuscleDataThisWeekHint:
      "Bearbeite deine Workouts und erstelle Übungsinfos, absolviere dann Sätze der Workouts, um hier eine Visualisierung zu sehen",
  ...
  en: {
    ...
    workoutName: "Workout name",
    workoutIcon: "Workout icon",
    workoutIconNone: "No icon",
    workoutScheduleDays: "Planning",
    workoutScheduleDaysHelp: "Explain planning",
    workoutScheduleDaysHelpDescription:
      "On the selected days, the workout is highlighted",
    ...
    weekStartsOnMonday: "Mon",
    weekStartsOnSunday: "Sun",
    ...
    completeWithoutTemplate: "Save session only",
    completeWithTemplate: "Save session and update template",
    ...
    expandAllExercises: "Expand all",
    collapseAllExercises: "Collapse all",
    reorderMode: "Reorder",
    reorderModeStart: "Start reorder mode",
    reorderModeDone: "Done reordering",
    reorderModeDescription: "Exercises collapse. Drag them by the handle to change the order in this active session.",
    reorderModeHint: "Drag exercises by the handle to reorder them",
    reorderExercise: "Reorder exercise",
    reverseSessionExerciseOrder: "Reverse exercise order",
    reverseShort: "Reverse",
    reverseSessionExerciseOrderConfirm: "Reverse the order of all not-yet-started exercises?",
    saveSorting: "Apply sorting",
    ...
    exerciseToggleHelp: "Explain 2× and −kg",
    exerciseHelp: "Open exercise help",
    exerciseInfo: "Exercise info",
    exerciseInfoGenerate: "Generate exercise info",
    exerciseInfoGenerating: "Generating exercise info ...",
    exerciseInfoGenerateSectionTitle: "Create exercise info automatically",
    exerciseInfoGenerateSectionDescription:
      "Matches named exercises to a local exercise catalog and creates target-muscle and coaching info from it",
    ...
    exerciseInfoReloadConfirmTitle: "Recreate exercise info?",
    exerciseInfoReloadConfirmDescription:
      "All exercises in this workout already have info. Do you want to remove the existing exercise info and recreate it?",
    exerciseInfoReloadConfirmAction: "Remove and recreate",
    exerciseInfoGenerateFailed: "Could not create exercise info",
    exerciseInfoProviderNotConfigured: "Exercise catalog is unavailable",
    ...
    matchedExerciseNameLabel: "Info for",
    ...
    aiImport: "AI Import",
    aiGenerate: "Create workouts with AI",
    ...
    bodyWeightHint:
      "Used to calculate weight for assisted exercises with negative values and for the calorie estimate in statistics",
    ...
    muscleMetricsCalculationHint: "Weighted by exercise muscle involvement per completed set (for weight: volume = weight × reps)",
    noMuscleDataThisWeek: "No muscle-group data yet",
    noMuscleDataThisWeekHint:
      "Edit your workouts and create exercise info, then complete workout sets to see a visualization here",
