...
export const messages = {
  de: {
    ...
    aiImportEntryHint: "Importiere einen Trainingsplan aus Text mit KI-Unterstützung oder nutze den JSON-Import",
  ...
  en: {
    ...
    aiImportEntryHint: "Import a workout plan from text with AI help, or use the JSON import flow",
