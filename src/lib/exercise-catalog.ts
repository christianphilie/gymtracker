...
// Broader catalog expansion with common gym machine/cable/grip/unilateral variants
const EXTRA_VARIANTS_2: ExerciseCatalogEntry[] = [
  ...
  ex("push_up_handles", "Liegestütz (Griffe)", "Push-Up (Handles)", "push_up", [...TARGETS.pushUp], ["push up handles"]),
  ex("deficit_push_up", "Deficit Liegestütz", "Deficit Push-Up", "push_up", [...TARGETS.pushUp]),
  ex("decline_push_up", "Decline Liegestütz", "Decline Push-Up", "push_up", [tm("upper_chest", 35), tm("mid_chest", 25), tm("anterior_delts", 25), tm("triceps_lateral_head", 15)]),
  ex("machine_fly", "Brust-Fly (Maschine)", "Machine Chest Fly", "chest_fly", [...TARGETS.flyChest], ["chest fly machine"]),
  ...
  ex("close_grip_seated_row", "Sitzendes Rudern (eng)", "Close-Grip Seated Row", "horizontal_row", [...TARGETS.row], ["close cable row"]),
  ...
  ex("rear_delt_machine_row", "Rear Delt Row (Maschine)", "Rear Delt Row Machine", "rear_delt_raise", [tm("rear_delts", 45), tm("mid_traps", 25), tm("upper_traps", 10), tm("biceps_brachii", 10), tm("rotator_cuff", 10)]),
  ...
  ex("push_press", "Push Press", "Push Press", "shoulder_press", [tm("anterior_delts", 30), tm("medial_delts", 25), tm("triceps_long_head", 15), tm("triceps_lateral_head", 10), tm("gluteus_maximus", 10), tm("rectus_abdominis", 10)]),
  ex("z_press", "Z-Press", "Z-Press", "shoulder_press", [tm("anterior_delts", 35), tm("medial_delts", 30), tm("triceps_long_head", 15), tm("triceps_lateral_head", 10), tm("rectus_abdominis", 10)]),
  ex("single_arm_landmine_press", "Einarmiger Landmine Press", "Single-Arm Landmine Press", "shoulder_press", [tm("anterior_delts", 40), tm("upper_chest", 20), tm("medial_delts", 15), tm("triceps_lateral_head", 10), tm("rectus_abdominis", 15)]),
  ...
  ex("scaption_raise", "Scaption Raise", "Scaption Raise", "front_raise", [tm("anterior_delts", 35), tm("medial_delts", 25), tm("rotator_cuff", 30), tm("upper_traps", 10)]),
  ex("front_plate_raise", "Frontheben (Scheibe)", "Plate Front Raise", "front_raise", [...TARGETS.frontRaise]),
  ex("cable_y_raise", "Y-Raise (Kabel)", "Cable Y-Raise", "rear_delt_raise", [tm("lower_traps", 30), tm("rear_delts", 25), tm("mid_traps", 20), tm("rotator_cuff", 15), tm("serratus_anterior", 10)]),
  ex("reverse_cable_y_raise", "Reverse Y-Raise (Kabel)", "Reverse Cable Y-Raise", "rear_delt_raise", [tm("lower_traps", 30), tm("rear_delts", 30), tm("mid_traps", 20), tm("rotator_cuff", 20)]),
  ...
  ex("drag_curl", "Drag Curl", "Drag Curl", "curl", [tm("biceps_brachii", 50), tm("brachialis", 25), tm("rear_delts", 10), tm("brachioradialis", 15)]),
  ex("single_arm_cable_curl", "Einarmiger Bizepscurl (Kabel)", "Single-Arm Cable Curl", "curl", [...TARGETS.curl]),
  ex("high_cable_curl", "High Cable Curl", "High Cable Curl", "curl", [...TARGETS.curl], ["double biceps cable curl"]),
  ...
  ex("reverse_grip_triceps_pushdown", "Trizepsdrücken Untergriff (Kabel)", "Reverse-Grip Triceps Pushdown", "triceps_pushdown", [tm("triceps_medial_head", 40), tm("triceps_lateral_head", 30), tm("triceps_long_head", 20), tm("forearm_flexors", 10)]),
  ...
  ex("triceps_kickback_dumbbell", "Trizeps Kickback (Kurzhantel)", "Dumbbell Triceps Kickback", "triceps_pushdown", [tm("triceps_lateral_head", 35), tm("triceps_long_head", 35), tm("triceps_medial_head", 20), tm("rear_delts", 10)]),
  ...
  ex("zercher_squat", "Zercher Squat", "Zercher Squat", "squat", [tm("rectus_femoris", 25), tm("vastus_lateralis", 20), tm("vastus_medialis", 20), tm("gluteus_maximus", 15), tm("erector_spinae", 10), tm("rectus_abdominis", 10)]),
  ex("belt_squat", "Belt Squat", "Belt Squat", "squat", [tm("rectus_femoris", 25), tm("vastus_lateralis", 25), tm("vastus_medialis", 20), tm("gluteus_maximus", 20), tm("gluteus_medius", 10)]),
  ex("pendulum_squat", "Pendulum Squat", "Pendulum Squat", "squat", [tm("rectus_femoris", 30), tm("vastus_lateralis", 25), tm("vastus_medialis", 20), tm("vastus_intermedius", 15), tm("gluteus_maximus", 10)]),
  ...
  ex("leg_press_high_feet", "Beinpresse (Füße hoch)", "Leg Press (High Feet)", "leg_press", [tm("gluteus_maximus", 25), tm("biceps_femoris", 15), tm("rectus_femoris", 20), tm("vastus_lateralis", 20), tm("vastus_medialis", 20)]),
  ex("leg_press_low_feet", "Beinpresse (Füße tief)", "Leg Press (Low Feet)", "leg_press", [tm("rectus_femoris", 30), tm("vastus_lateralis", 25), tm("vastus_medialis", 25), tm("vastus_intermedius", 15), tm("gluteus_maximus", 5)]),
  ex("narrow_stance_leg_press", "Beinpresse (enger Stand)", "Narrow-Stance Leg Press", "leg_press", [...TARGETS.legPress]),
  ex("wide_stance_leg_press", "Beinpresse (weiter Stand)", "Wide-Stance Leg Press", "leg_press", [tm("adductors", 20), tm("gluteus_maximus", 20), tm("rectus_femoris", 20), tm("vastus_lateralis", 20), tm("vastus_medialis", 20)]),
  ...
  ex("lateral_lunge", "Side Lunge", "Side Lunge", "lunge", [tm("adductors", 25), tm("gluteus_maximus", 20), tm("gluteus_medius", 15), tm("rectus_femoris", 15), tm("vastus_lateralis", 15), tm("vastus_medialis", 10)]),
  ex("cossack_squat", "Cossack Squat", "Cossack Squat", "lunge", [tm("adductors", 25), tm("gluteus_medius", 20), tm("gluteus_maximus", 15), tm("rectus_femoris", 15), tm("vastus_lateralis", 15), tm("vastus_medialis", 10)]),
  ...
  ex("trap_bar_deadlift", "Trap-Bar Kreuzheben", "Trap Bar Deadlift", "hip_hinge", [tm("gluteus_maximus", 25), tm("rectus_femoris", 15), tm("vastus_lateralis", 15), tm("vastus_medialis", 10), tm("biceps_femoris", 10), tm("erector_spinae", 15), tm("upper_traps", 10)]),
  ...
  ex("single_leg_rdl", "Einbeiniger Romanian Deadlift", "Single-Leg Romanian Deadlift", "hip_hinge", [tm("gluteus_maximus", 30), tm("gluteus_medius", 20), tm("biceps_femoris", 15), tm("semitendinosus", 10), tm("semimembranosus", 10), tm("erector_spinae", 10), tm("rectus_abdominis", 5)]),
  ...
  ex("single_leg_hip_thrust", "Einbeiniger Hip Thrust", "Single-Leg Hip Thrust", "hip_thrust", [tm("gluteus_maximus", 55), tm("gluteus_medius", 20), tm("biceps_femoris", 15), tm("rectus_abdominis", 10)]),
  ex("frog_pump", "Frog Pump", "Frog Pump", "hip_thrust", [tm("gluteus_maximus", 65), tm("gluteus_medius", 15), tm("adductors", 10), tm("erector_spinae", 10)]),
  ex("kas_glute_bridge", "Kas Glute Bridge", "Kas Glute Bridge", "hip_thrust", [tm("gluteus_maximus", 70), tm("gluteus_medius", 15), tm("biceps_femoris", 10), tm("erector_spinae", 5)]),
  ...
  ex("nordic_hamstring_curl", "Nordic Hamstring Curl", "Nordic Hamstring Curl", "leg_curl", [tm("biceps_femoris", 45), tm("semitendinosus", 30), tm("semimembranosus", 20), tm("gastrocnemius", 5)]),
  ex("glute_ham_raise", "Glute-Ham Raise", "Glute-Ham Raise", "leg_curl", [tm("biceps_femoris", 35), tm("semitendinosus", 25), tm("semimembranosus", 20), tm("gluteus_maximus", 15), tm("erector_spinae", 5)]),
  ex("cable_leg_curl", "Beinbeuger (Kabel)", "Cable Leg Curl", "leg_curl", [...TARGETS.legCurl]),
  ex("sissy_squat", "Sissy Squat", "Sissy Squat", "leg_extension", [tm("rectus_femoris", 35), tm("vastus_lateralis", 25), tm("vastus_medialis", 25), tm("vastus_intermedius", 15)]),
  ...
  ex("toe_to_bar", "Toes-to-Bar", "Toes-to-Bar", "leg_raise", [tm("rectus_abdominis", 35), tm("iliopsoas", 30), tm("transversus_abdominis", 15), tm("external_obliques", 10), tm("internal_obliques", 10)]),
  ...
  ex("garhammer_raise", "Garhammer Raise", "Garhammer Raise", "leg_raise", [tm("rectus_abdominis", 45), tm("transversus_abdominis", 20), tm("iliopsoas", 20), tm("external_obliques", 10), tm("internal_obliques", 5)]),
  ex("hollow_body_hold", "Hollow Hold", "Hollow Body Hold", "plank", [tm("transversus_abdominis", 30), tm("rectus_abdominis", 30), tm("external_obliques", 15), tm("internal_obliques", 15), tm("iliopsoas", 10)]),
  ex("body_saw_plank", "Body Saw Plank", "Body Saw Plank", "plank", [tm("transversus_abdominis", 35), tm("rectus_abdominis", 25), tm("external_obliques", 15), tm("internal_obliques", 15), tm("serratus_anterior", 10)]),
  ex("pallof_press", "Pallof Press", "Pallof Press", "rotation_core", [tm("external_obliques", 30), tm("internal_obliques", 25), tm("transversus_abdominis", 20), tm("rectus_abdominis", 15), tm("serratus_anterior", 10)]),
  ex("pallof_hold", "Pallof Hold", "Pallof Hold", "rotation_core", [tm("external_obliques", 30), tm("internal_obliques", 25), tm("transversus_abdominis", 25), tm("rectus_abdominis", 10), tm("serratus_anterior", 10)]),
  ...
  ex("bird_dog", "Bird Dog", "Bird Dog", "plank", [tm("transversus_abdominis", 25), tm("erector_spinae", 20), tm("gluteus_maximus", 20), tm("rectus_abdominis", 15), tm("external_obliques", 10), tm("internal_obliques", 10)]),
  ex("superman_hold", "Superman Hold", "Superman Hold", "back_extension", [tm("erector_spinae", 40), tm("gluteus_maximus", 20), tm("mid_traps", 15), tm("rear_delts", 10), tm("biceps_femoris", 15)]),
